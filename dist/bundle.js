...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Scene)\n/* harmony export */ });\n/* harmony import */ var _charges_point_charge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./charges/point_charge */ \"./src/charges/point_charge.ts\");\n/* harmony import */ var _vector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vector */ \"./src/vector.ts\");\n\n\nclass Scene {\n    constructor(element) {\n        this.updateAspectRatio = () => {\n            let aspectRatio = window.innerWidth / window.innerHeight;\n            this.height = Scene.parameters.viewportHeight * 2;\n            this.width = aspectRatio * this.height;\n            this.element.width = window.innerWidth;\n            this.element.height = window.innerHeight;\n            this.context.resetTransform();\n            this.context.translate(window.innerWidth / 2, window.innerHeight / 2);\n            let scale = window.innerHeight / 2 / Scene.parameters.viewportHeight;\n            this.context.scale(scale, scale);\n        };\n        this.render = () => {\n            requestAnimationFrame(this.render);\n            this.context.clearRect(0, 0, this.width, this.height);\n            this.objects.forEach((object) => {\n                object.render(this.context);\n            });\n        };\n        this.fieldAt = (pos) => {\n            let out = _vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"].origin();\n            this.objects.forEach((object) => {\n                out.add(object.fieldAt(pos));\n            });\n            return out;\n        };\n        this.voltageAt = (pos) => {\n            let potential = 0;\n            this.objects.forEach((object) => {\n                potential += object.voltageAt(pos);\n            });\n            return potential;\n        };\n        this.forceBetween = (a, b) => {\n            if (a instanceof _charges_point_charge__WEBPACK_IMPORTED_MODULE_0__[\"default\"]) {\n            }\n            return { force: _vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"].origin(), torque: 0 };\n        };\n        this.objects = [];\n        this.element = element;\n        this.context = element.getContext(\"2d\");\n        this.updateAspectRatio();\n        this.render();\n        this.context.textAlign = \"center\";\n    }\n    physics(dt) {\n        this.objects.forEach((object) => {\n            object.incrementPosition(dt);\n        });\n    }\n}\nScene.parameters = {\n    viewportHeight: 10,\n    physicsPerSecond: 100,\n    timeSpeed: 1,\n};\nvar scene;\ndocument.addEventListener(\"DOMContentLoaded\", () => {\n    let canvas = document.getElementById(\"canvas\");\n    scene = new Scene(canvas);\n    scene.objects.push(new _charges_point_charge__WEBPACK_IMPORTED_MODULE_0__[\"default\"](1, 1, new _vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](0, 0)));\n    scene.objects.push(new _charges_point_charge__WEBPACK_IMPORTED_MODULE_0__[\"default\"](1, 1, new _vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](2, 0)));\n    scene.objects.push(new _charges_point_charge__WEBPACK_IMPORTED_MODULE_0__[\"default\"](1, 1, new _vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](0, -2)));\n});\n\n\n//# sourceURL=webpack://efield_simulator/./src/scene.ts?");
